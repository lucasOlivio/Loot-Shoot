...
namespace MyEngine
{
    ...
    void MenuSystem::Start(std::shared_ptr<Scene> pScene)
    {
    }

    void MenuSystem::Update(std::shared_ptr<Scene> pScene, float deltaTime)
    {
    }
    ...
    void MenuSystem::End(std::shared_ptr<Scene> pScene)
    {
    }
