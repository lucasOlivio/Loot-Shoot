...
namespace MyEngine
{
	...
	public:
		...
		virtual std::shared_ptr<iShaderProgram> GetShaderProgramFromName(std::string& shaderProgram) = 0;
		virtual std::shared_ptr<iShaderProgram> GetShaderProgramFromID(uint shaderProgramID) = 0;
