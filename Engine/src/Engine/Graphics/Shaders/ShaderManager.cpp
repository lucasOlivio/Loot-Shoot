...
namespace MyEngine
{
	std::shared_ptr<iShaderProgram> ShaderManager::m_pActiveShader = nullptr;
	...
	std::shared_ptr<iShaderProgram> ShaderManager::GetShaderProgramFromName(std::string& shaderProgram)
	{
		uint shaderProgramID = GetIDFromShaderProgramName(shaderProgram);

		// Now get the actual shader

		std::map< uint /*ID*/, std::shared_ptr<iShaderProgram> >::iterator
		...
		std::shared_ptr<iShaderProgram> pShaderProgram = itShaderProgram->second;

		return pShaderProgram;
	}

	std::shared_ptr<iShaderProgram> ShaderManager::GetShaderProgramFromID(uint shaderProgramID)
	{
		// Now get the actual shader
		std::map< uint /*ID*/, std::shared_ptr<iShaderProgram> >::iterator
			itShaderProgram = m_IDToShaderProgram.find(shaderProgramID);
	...
	std::shared_ptr<iShaderProgram> ShaderManager::GetActiveShader()
	{
