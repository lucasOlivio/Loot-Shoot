...
private:
    ...
    */
    ...
    /** Export FBX scene.
      ...
      */
    xmlNode * ExportScene(Fbxstd::shared_ptr<Scene> pScene);
    ...
    * \param pNode FBX node to export, it should be animated.
    * \param animationNode Pointer to XML Node, created sub-animation nodes will be added as children to this XML node.
    * \return true on success.
    */
    bool		ExportAnimationCurves(FbxNode* pNode, xmlNode* animationNode);
    ...
    * \param animationNode Pointer to XML Node, created sub-animation node will be added as child to this XML node.
    ...
    */
    bool		ExportCurve(xmlNode* animationNode, FbxAnimCurve* pCurve,
