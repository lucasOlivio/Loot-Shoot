...
public:
	...
	//@{
		...
		* \param rotation Rotation element.
		* \param pShearing Shearing element.
		* \param pScaling Scaling element.
		* \param pSign Sign of determinant. */
		void GetElements(FbxVector4& pTranslation, FbxQuaternion& rotation, FbxVector4& pShearing, FbxVector4& pScaling, double& pSign) const;
		...
		* \param pScaling Scaling element.
		* \param pSign Sign of determinant. */
		void GetElements(FbxVector4& pTranslation, FbxVector4& rotation, FbxVector4& pShearing, FbxVector4& pScaling, double& pSign) const;
	//@}
