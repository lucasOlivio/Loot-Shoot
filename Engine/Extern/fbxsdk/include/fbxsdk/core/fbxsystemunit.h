...
public:
    ...
    /** Converts a scene from its system units to this system unit.
      ...
      */
    void ConvertScene( Fbxstd::shared_ptr<Scene> pScene, const ConversionOptions& pOptions = DefaultConversionOptions ) const;
    ...
    /** Converts a scene from its system unit to this system unit, using the specified 
      ...
      * and instead you should use ConvertScene( Fbxstd::shared_ptr<Scene> , const ConversionOptions&  ) whenever possible.
      * \param pScene The scene to convert.
      * \param pFbxRoot The Fbx_Root node to use for conversion.
      * \param pOptions Conversion options, see:FbxSystemUnit::ConversionOptions
      */
    void ConvertScene( Fbxstd::shared_ptr<Scene> pScene, FbxNode* pFbxRoot, const ConversionOptions& pOptions = DefaultConversionOptions ) const;
...
private:
    ...
    void AdjustPoses(Fbxstd::shared_ptr<Scene> pScene, double pConversionFactor) const;
