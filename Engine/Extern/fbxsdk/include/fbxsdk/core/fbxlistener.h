...
public:
    ...
    */
	 ...
	 * \param emitter          Event emitter to bind. Current listener can listen to the event which is emitted by emitter.
	 * \param pFunc             The callback function to process event date.
	 * \return                  The automatically created event handler.
	 */
    template <typename EventType,typename ListenerType> FbxEventHandler* Bind(FbxEmitter& emitter, void (ListenerType::*pFunc)(const EventType*))
    {
        ...
        emitter.AddListener(*eventHandler);
    ...
    * \return                  The automatically created event handler.
    */
    template <typename EventType,typename ListenerType> FbxEventHandler* Bind(FbxEmitter& emitter, void (ListenerType::*pFunc)(const EventType*)const)
    {
    ...
    * \return                  The automatically created event handler.
    */
    template <typename EventType> FbxEventHandler* Bind(FbxEmitter& emitter, void (*pFunc)(const EventType*,FbxListener*))
    {
