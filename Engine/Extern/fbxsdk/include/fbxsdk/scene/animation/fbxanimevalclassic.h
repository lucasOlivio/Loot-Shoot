...
class FBXSDK_DLL FbxAnimEvalClassic : public FbxAnimEvaluator
{
	...
	* \param rotationOrder The rotation order to be used for blending.
	...
	*/
	void BlendRotation(double* pResult, int pResultSize, double* pApply, int pApplySize, double pWeight, FbxAnimLayer::EBlendMode pBlendMode, FbxAnimLayer::ERotationAccumulationMode pRotAccuMode, int rotationOrder);
