...
public:
    ...
    static int SplitAnimationIntoMultipleStacks(Fbxstd::shared_ptr<Scene> pScene, const FbxArray<FbxAnimSplitDef*>& pAnimSplitDefinitions, const FbxAnimStack* pSrcAnimStack, FbxArray<FbxAnimStack*>& pDstStacks);
    static void ShareAnimCurves(FbxProperty& pDstProperty, FbxProperty& pSrcProperty, Fbxstd::shared_ptr<Scene> pScene);
