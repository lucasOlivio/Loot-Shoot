...
public:
	...
	//@{
		...
		/** Get the list of Poses objects that contain the node with name pNodeName.
		  ...
		  *  The elements of the returned list must not be deleted since they still belong to the scene.
		  */
		static bool GetPosesContaining(Fbxstd::shared_ptr<Scene> pScene, FbxNode* pNode, PoseList& pPoseList, FbxArray<int>& pIndex);
		...
		/** Get the list of BindPose objects that contain the node with name pNodeName.
		  ...
		  *  The elements of the returned list must not be deleted since they still belong to the scene.
		  */
		static bool GetBindPoseContaining(Fbxstd::shared_ptr<Scene> pScene, FbxNode* pNode, PoseList& pPoseList, FbxArray<int>& pIndex);
		...
		/** Get the list of RestPose objects that contain the node with name pNodeName.
		  ...
		  *  The elements of the returned list must not be deleted since they still belong to the scene.
		  */
		static bool GetRestPoseContaining(Fbxstd::shared_ptr<Scene> pScene, FbxNode* pNode, PoseList& pPoseList, FbxArray<int>& pIndex);
...
protected:
    ...
    static bool			GetSpecificPoseContaining(int poseType, Fbxstd::shared_ptr<Scene> pScene, FbxNode* pNode, PoseList& pPoseList, FbxArray<int>& pIndex);
