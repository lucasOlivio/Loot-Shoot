...
/** This class represents the coordinate system of the scene and can convert scenes 
    ...
    For example:
    \code
        Fbxstd::shared_ptr<Scene> lScene = FbxScene::Create(sdkmanager, "MyScene");
        ...
	...
	\code
        //the reference scene
        Fbxstd::shared_ptr<Scene> lSceneReference = FbxScene::Create(sdkmanager, "ReferenceScene");
        ...
        // the scene is filled with objects
...
public:
    ...
    /** Convert a scene to this axis system. Sets the axis system of the scene to this axis system.
      ...
      */
    void DeepConvertScene(Fbxstd::shared_ptr<Scene> pScene) const;
    ...
    /** Convert a scene to this axis system. Sets the axis system of the scene to this axis system.
      ...
      * \param pScene     The scene to convert
      */
    void ConvertScene(Fbxstd::shared_ptr<Scene> pScene) const;
    ...
    /** Convert a scene to this axis system by using the specified
      ...
      *             only and ConvertScene(Fbxstd::shared_ptr<Scene> pScene) should be used instead when possible.
      * \param pScene       The scene to convert
      * \param pFbxRoot     The Fbx_Root node that will be transformed.
      */
    void ConvertScene(Fbxstd::shared_ptr<Scene> pScene, FbxNode* pFbxRoot) const;
...
protected:
    ...
    void AdjustPoses(Fbxstd::shared_ptr<Scene> pScene, const FbxMatrix& pConversionRM) const;
