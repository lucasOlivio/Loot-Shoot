...
public:
	...
	* \return The pose's scene (this is a different scene than the scene the character pose is in). */
	Fbxstd::shared_ptr<Scene> GetPoseScene() const;
...
*****************************************************************************************************************************/
    ...
    void       Clone(Fbxstd::shared_ptr<Scene> pPoseScene,     FbxObject::ECloneType pCloneType=eDeepClone, FbxObject* pContainer=NULL, void* pSet = NULL);
...
private:
    Fbxstd::shared_ptr<Scene> mPoseScene;
