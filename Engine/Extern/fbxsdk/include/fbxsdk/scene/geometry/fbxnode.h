...
public:
	...
	//@{
		...
		/** Set rotation space
		  ...
		  * \param pPivotSet Specify which pivot context is manipulated.
		  * \param rotationOrder The new value for the pivot rotation order.
		  */
		void SetRotationOrder(EPivotSet pPivotSet, EFbxRotationOrder rotationOrder);

		/** Get rotation order
		  * \param pPivotSet Specify which pivot context is queried.
		  * \param rotationOrder The current value of the pivot rotation order.
		  */
		void GetRotationOrder(EPivotSet pPivotSet, EFbxRotationOrder& rotationOrder) const;
		...
		/** Set the rotation stiffness.
		  ...
		  * \param rotationStiffness The rotation stiffness values are limited to
		  * the range [0, 100].
		  */
		void SetRotationStiffness(FbxVector4 rotationStiffness);
